  ...
  return (
   ...
   <div className="flex bg-white rounded-2xl sm:rounded-[3rem] w-3/4">
      <div className="p-8 w-full sm:w-[65%]">
        ...
        <button  onClick={()=>{router.push("/epr")}} className="bg-black rounded-2xl p-1 text-white pl-5 pr-5 hover:bg-gray">Schedule Consultation</button>
      </div>
      <div className=" w-0 sm:w-[35%]">
        <img src="/fact.png" className="h-full w-full bg-cover" />
      </div>
    </div>
   </div>
  </div>
