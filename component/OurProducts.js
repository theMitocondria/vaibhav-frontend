  ...
  return (
    <div id='products' className='bg-products pb-32  sm:pb-0 sm:h-screen'>
        ...
        <div className=' flex-col  sm:flex-row flex justify-center items-center h-full' >
            <button onClick={() => router.push("/products/biodegradable")} className='sm:w-[27%]  sm:h-[40%] w-[60%] mb-5 h-[40%] sm:hover:h-[55%]  transition-all duration-500  mr-2 rounded-xl sm:rounded-none sm:rounded-l-3xl flex flex-col items-center justify-evenly bg-gray'>
            ...
            <button onClick={() => router.push("/products/composite")}  className='sm:w-[27%]  sm:h-[40%] w-[60%] h-[40%] mb-5   text-center sm:hover:h-[55%] transition-all duration-500 rounded-xl sm:rounded-none sm:rounded-r-3xl flex flex-col items-center justify-evenly bg-white'>
